...
class NetworkApiService extends BaseApiServices {
  ...
  Future<Response> retryMethod(FutureOr<Response> Function() fn) {
    return r.retry(fn, retryIf: (e) => e is TimeoutException);
  }
  ...
  Future multiPartApiResponse(
    ...
    try {
      ...
      Response response = await convertStreamedResponseToResponse(
        streamResponse,
      );
      responseJson = returnResponse(response);
    } on SocketException {
    ...
    switch (response.statusCode) {
      ...
      case 400:
        throw BadRequestException(
          error['mess'] ?? error['message'] ?? "Bad Request",
        );
      case 404:
        throw UnauthorisedException(error['mess']);
      case 501:
        throw NotImplementedException(error['mess']);
      case 505:
      ...
      case 401:
        throw UnAuthorizedException(error['mess']);
      case 409:
        throw ConflictException(error['mess']);
      case 503:
